...
void QHexEdit::setSelectionRange(int begin, int end)
{
    qHexEdit_p->setSelectionRange(begin * 2, end * 2);
}

void QHexEdit::setFile(QSharedPointer<QFile> const &dataFile)
{
    qHexEdit_p->setFile(dataFile);
}

void QHexEdit::saveTo(QFile &file)
{
    qHexEdit_p->saveTo(file);
}
